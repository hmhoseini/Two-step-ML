...
possible_ternarycompounds = []
#with open('A3B3C3_finalcompositions_reduced_formula.out', 'r') as fp:
with open('../A3B3C3/A3B3C3_unique-compositions_reduced_formula_list.dat', 'r') as fhandle:
    lines = fhandle.readlines()
for line in lines:
    line = line.strip()
    possible_ternarycompounds.append(line)
...
for a_possible_ternary in possible_ternarycompounds:
    ABC_comp = Composition(a_possible_ternary)
    ABC = a_possible_ternary
        ...
        for n in range (0, len(AB)):
            for m in range (0, len(AC)):
                ...
                if   (X-0.01)< a*x+b*xp < (X+0.01):
                    ...
                    print('{}, {:.3f}, {}, {:.3f}, {:.3f}, {}, {:.3f}, {:.3f}'.format(ABC,\
                            a, AB_compound.reduced_formula, AB_energy,\
                            b, AC_compound.reduced_formula, AC_energy, E_heuristic))
        ...
        for n in range (0, len(AB)):
            for m in range (0, len(BC)):
                ...
                if   (Y-0.01)< a*y+b*yp < (Y+0.01):
                    ...
                    print('{}, {:.3f}, {}, {:.3f}, {:.3f}, {}, {:.3f}, {:.3f}'.format(ABC,\
                            a, AB_compound.reduced_formula, AB_energy,\
                            b,BC_compound.reduced_formula, BC_energy, E_heuristic))
        ...
        for n in range (0, len(AC)):
            for m in range (0, len(BC)):
                ...
                if   (Z-0.01)< a*z+b*zp < (Z+0.01):
                    ...
                    print ('{}, {:.3f}, {}, {:.3f}, {:.3f}, {}, {:.3f}, {:.3f}'.format(ABC,\
                             a, AC_compound.reduced_formula, AC_energy,\
                             b, BC_compound.reduced_formula, BC_energy, E_heuristic))
