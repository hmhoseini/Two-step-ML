...
for line in lines:
    ...
    ternary_comp = Composition(line[0])
    first_comp   = Composition(line[2])
    second_comp  = Composition(line[5])
...
#abs_diff_X_second_comp = diff_X_second_comp
    ...
    print('{:.3f}, {:.3f}, {:.3f}, {:.3f}'.format(s_frac_second_comp, p_frac_second_comp, d_frac_second_comp, f_frac_second_comp))
