...
This implementation uses the bias-corrected m_t_hat as an approximation of the expected value.

Original Adam code modified by Sebastian Jost to create cAdamHat (cAdam using \hat{m}_t as gradient approximation).
"""
...
class cAdamHat(keras.optimizers.Optimizer):
    def __init__(self,
                 learning_rate=0.01,
                 beta_1=0.9,
                 beta_2=0.999,
