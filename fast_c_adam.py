"""
faster implementation of centered Adam (cAdam) optimizer, a variation of Adam.

Original Adam code modified by Sebastian Jost to implement cAdam with typical performance improvements used for Adam.
"""
...
class fastcAdam(keras.optimizers.Optimizer):
    def __init__(self,
                 learning_rate=0.01,
                 beta_1=0.9,
                 beta_2=0.999,
    ...
    def _prepare_local(self, var_device, var_dtype, apply_state):
        ...
        lr = self._get_hyper("learning_rate") / (1 - beta_1_power) * math_ops.sqrt(1 - beta_2_power)
